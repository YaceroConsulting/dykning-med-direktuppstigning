const footerNavigation = {
    social: [
        {
          name: 'Facebook',
          href: 'https://www.facebook.com/yacero.ab/',
          icon: (props: object) => (
        ...
        {
            name: 'LinkedIn',
            href: 'https://www.linkedin.com/company/yacero-ab/posts/?feedView=all&viewAsMember=true',
            icon: (props: object) => (
        ...
        {
            name: 'Instagram',
            href: 'https://yacero.se/instagram/',
            icon: (props: object) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                    <path
        ...
        {
            name: 'GitHub',
            href: 'https://github.com/YaceroConsulting/diving-group-practice',
            icon: (props: object) => (
                <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
                    <path
                        fillRule="evenodd"
            ...
            <div className="mx-auto max-w-7xl px-6 pb-8 lg:px-8">
                ...
                <div
                    ...
                    <p className="mt-8 text-xs leading-5 text-gray-500 md:order-1 md:mt-0">
                        &copy; 2024 Yacero AB, Inc. Med ensamrätt.
                    </p>
                </div>
            </div>
        </footer>
